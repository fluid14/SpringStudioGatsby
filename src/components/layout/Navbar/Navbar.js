            ...
            <div className="relative z-20 flex items-center justify-between px-4 py-5 bg-transparent">
                <div className="w-auto">
                    <div className="flex flex-wrap items-center">
                        <div className="w-auto mr-14"><a href="#"><img className="nav-logo"
                                                                       src="flaro-assets/logos/logoBold.svg"
                                                                       alt="Spring Studio"/></a></div>
                        <div className="w-auto hidden lg:block">
                            <ul className="flex items-center mr-16">
                                <li className="mr-9 font-medium hover:text-gray-700"><a href="#jakToDziała?">Jak to
                                    działa?</a></li>
                                <li className="mr-9 font-medium hover:text-gray-700"><a
                                    href="#aleIleToKosztuje?">Cennik</a></li>
                                <li className="font-medium hover:text-gray-700"><a href="#kontakt">Kontakt</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div className="w-auto">
                    <div className="flex flex-wrap items-center">
                        ...
                        <div className="w-auto lg:hidden"><a href="#" id="navbar-burger">
                            <svg className="navbar-burger text-indigo-600" width="51" height="51" viewBox="0 0 56 56"
                    ...
                    <div className="flex flex-wrap justify-between h-full">
                        <div className="w-full">
                            <div className="flex items-center justify-between -m-2">
                                <div className="w-auto p-2"><a className="inline-block" href="#"><img
                                    className="nav-logo" src="flaro-assets/logos/logoBold.svg" alt="Spring Studio"/></a>
                                </div>
                        ...
                        <div className="flex flex-col justify-center py-16 w-full">
                            <ul>
                                <li className="mb-12"><a className="font-medium hover:text-gray-700"
