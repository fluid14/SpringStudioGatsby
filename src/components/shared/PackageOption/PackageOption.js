...
const PackageOption = ({data}) => {
    const {title, description: {data: description}, price, priceAdditional, chooseContactLabel, options, isMark} = data;
        ...
        const onPageLoad = () => {
            ...
            const onClick = btn => {
                btn.addEventListener('click', () => {
                    ...
                    chooseContactLabel ? formTitleText = chooseContactLabel : formTitleText = 'Masz pytania?';
            ...
            if (chooseButtonMark) chooseButtonMark.addEventListener('click', () => onClick(chooseButtonMark));
        }
                ...
                <div>
                    ...
                    {!isMark &&
                        <button
                            ...
                            type="button" ref={chooseButtonRef}>
                            Wybieram
                        </button>
                    }
                    ...
                    {isMark &&
                        <button
                            ...
                            type="button" ref={chooseButtonMarkRef}>
                            Wybieram
                        </button>
                    }
                    <ul>
                        {options.length > 0 && options.map(({text, id}) => (
