...
const WhatWeDo = ({data}) => {
    const {title, description: {data: {childMarkdownRemark: {html: description}}}, whatWeDoBlock, componentId} = data;

    return (
        <section className="pt-[50px] pb-[50px] md:pt-32 md:pb-36 bg-indigo-600 overflow-hidden" id={componentId}>
