...
const Faq = ({ data }) => {
  const {
    ...
    additional: {
      data: {
        childMarkdownRemark: { html: additional },
      },
    },
    faqElement,
    componentId,
  ...
  return (
    <section
      className="relative py-[50px] md:py-24 md:pb-12 bg-blueGray-50 overflow-hidden"
      id={componentId}
    >
      <img
      ...
      <div className="relative z-10 container px-4 mx-auto">
        <div className="md:max-w-4xl mx-auto">
          ...
          <div className="mb-11 flex flex-wrap -m-1">
            {faqElement.length > 0 &&
              faqElement.map((element) => <FaqElement data={element} key={element.id} />)}
          </div>
          <div
